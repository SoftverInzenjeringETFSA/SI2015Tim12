...
public class PDFGenerator {
	...
	public static void GenerisiPdf(Integer idRezervacijeInt, String tip){
        ...
        try {
            ...
            if(tip == "Potvrda")
            {
            	table.addCell(new Paragraph(osoba.getIme()+ " "+osoba.getPrezime()+", "+osoba.getBrojLicneKarte()+ ", "+osoba.getAdresa()+", "+osoba.getBrojTelefona()));
            }
            else
            {
            	table.addCell(new Paragraph(osoba.getIme()+ " "+osoba.getPrezime()+", "+osoba.getBrojLicneKarte()+ ", "+osoba.getAdresa()));
            }
